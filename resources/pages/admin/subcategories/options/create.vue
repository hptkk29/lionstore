    ...
    <v-container fluid class="pt-0" :class="$device.isMobileOrTablet ? 'px-2' : 'px-12'">
        ...
        <v-card flat class="c-card">
            <v-toolbar flat class="card-toolbar px-4">
                <v-toolbar-title class="font-weight-bold ff-default fs-13" v-text="$t('t_create_subcategory')"></v-toolbar-title>
                <v-spacer></v-spacer>
                <v-tooltip top>
    ...
    export default {
        ...
        methods: {
            ...
            async create() {
                ...
                // Send request to server
                await this.$axios
                            .post('dashboard/subcategories/options/create', data, config)
                            .then(response => {
