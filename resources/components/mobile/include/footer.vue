    ...
    <v-footer padless inset class="main-footer">
        <v-card flat tile  class="text-center fill-width" :color="$vuetify.theme.dark ? '#303030' : '#fff'">
            <v-card-text class="highlight-btn">
                ...
                <v-container fluid class="py-4">
                    <v-row>
                        ...
                        <!-- First column -->
                        <v-col cols="12" v-if="$store.state.settings.footer.first_column">
                        ...
                        <!-- Second column -->
                        <v-col cols="12" v-if="$store.state.settings.footer.second_column">
                        ...
                        <!-- Third column -->
                        <v-col cols="12" v-if="$store.state.settings.footer.third_column">
            ...
            <v-card-text class="footer-payment-services">
                ...
                <img v-if="$store.state.settings.footer.image" :src="`/uploads/${ $store.state.settings.footer.image.file_folder }/${ $store.state.settings.footer.image.uid }.webp`" height="30px" :alt="$store.state.settings.site_title" :title="$store.state.settings.site_title" />
