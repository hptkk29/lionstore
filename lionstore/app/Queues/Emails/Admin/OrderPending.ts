...
export default class OrderPendingQueue {
     ...
     * @param data 
     */
    constructor (data: Partial<OrderPendingQueue>) {
    ...
    public async queue() {
        ...
        // Set a queue
        const queue            = new Queue('admin::order::pending', { redis: Config.get('redis.connections.local') })
        ...
        queue.process(async function (job, done) {
            ...
            const html = await edge.render('emails/admin/order_pending', {
            ...
            await transporter.sendMail({
                ...
                subject: i18n.__('t_email_admin_order_pending', { site: settings_general?.site_title }),
                html   : html
            });
