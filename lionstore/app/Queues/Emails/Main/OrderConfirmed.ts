...
export default class OrderConfirmedQueue {
     ...
     * @param data 
     */
    constructor (data: Partial<OrderConfirmedQueue>) {
    ...
    public async queue() {
        ...
        // Set a queue
        const queue            = new Queue('customer::order::confirmed', { redis: Config.get('redis.connections.local') })
        ...
        queue.process(async function (job, done) {
            ...
            const html = await edge.render('emails/main/order_confirmed', {
            ...
            await transporter.sendMail({
                ...
                subject: i18n.__('t_email_customer_order_confirmed_subject', { site: settings_general?.site_title }),
                html   : html
            });
