...
export default class OrderShippedQueue {
     ...
     * @param data 
     */
    constructor (data: Partial<OrderShippedQueue>) {
    ...
    public async queue() {
        ...
        // Set a queue
        const queue            = new Queue('customer::order::shipped', { redis: Config.get('redis.connections.local') })
        ...
        queue.process(async function (job, done) {
            ...
            const html = await edge.render('emails/main/order_shipped', {
            ...
            await transporter.sendMail({
                ...
                subject: i18n.__('t_email_customer_order_shipped_subject', { site: settings_general?.site_title }),
                html   : html
            });
