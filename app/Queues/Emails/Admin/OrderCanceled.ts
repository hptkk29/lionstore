...
export default class OrderCanceledQueue {
     ...
     * @param data 
     */
    constructor (data: Partial<OrderCanceledQueue>) {
    ...
    public async queue() {
        ...
        // Set a queue
        const queue            = new Queue('admin::order::canceled', { redis: Config.get('redis.connections.local') })
        ...
        queue.process(async function (job, done) {
            ...
            const html = await edge.render('emails/admin/order_canceled', {
            ...
            await transporter.sendMail({
                ...
                subject: i18n.__('t_email_admin_order_canceled', { site: settings_general?.site_title }),
                html   : html
            });
